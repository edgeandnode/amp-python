...
class AsyncRegistryClient:
    """Async client for interacting with the Amp Registry API.
    ...
    def __init__(
        ...
        logger.info(f'Initialized async Registry client for {base_url}')

    @property
    def datasets(self):
        """Access the async datasets client.

        Returns:
            AsyncRegistryDatasetsClient: Client for dataset operations
        """
        from .async_datasets import AsyncRegistryDatasetsClient

        return AsyncRegistryDatasetsClient(self)
    ...
    async def _request(
        ...
        **kwargs,
        ...
        """Make an async HTTP request to the Registry API.
