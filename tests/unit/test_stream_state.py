...
from amp.streaming.types import BlockRange
...
class TestBatchIdentifier:
    ...
    def test_create_from_block_range(self):
        ...
        block_range = BlockRange(network='ethereum', start=100, end=200, hash='0xabc123', prev_hash='0xdef456')
    ...
    def test_unique_id_is_deterministic(self):
        ...
        batch_id1 = BatchIdentifier(
            network='ethereum', start_block=100, end_block=200, end_hash='0xabc123', start_parent_hash='0xdef456'
        )
    ...
    def test_to_block_range(self):
        ...
        batch_id = BatchIdentifier(
            network='arbitrum', start_block=1000, end_block=2000, end_hash='0x123', start_parent_hash='0x456'
        )
    ...
    def test_overlaps_or_after(self):
        ...
        batch_id = BatchIdentifier(network='ethereum', start_block=100, end_block=200, end_hash='0xabc')
